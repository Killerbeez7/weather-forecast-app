...
SECRET_KEY = 'django-insecure-1kay6(_v!_a8)km-5j@0lzl0r5gaew%iv8nq7+(v3fur%zjw^@'
...
WEATHER_DEFAULT_CITIES_COUNT = DEFAULT_CITIES_COUNT
WEATHER_REQUEST_TIMEOUT = REQUEST_TIMEOUT
WEATHER_UNITS = UNITS
